...
case class User(
  ...
  lazy val group = belongsTo[models.schema2.Group]

  val groupId: Option[Long] = None
}

object User extends ActiveRecordCompanion[User] with PlayFormSupport[User] with views.helpers.Bootstrap3Support[User] {
